import { sketches } from '/home/gaurav/Projects/bloging-app/src/sketches.js';
import { writeFileSync } from 'fs';

// New cute pencil-style doodles, drawn after Gaurav's reference sketches (2026-09-13).
const cute = [
  { name: 'cat-with-flower', box: '0 0 64 64', w: 2,
    d: ['M10 50c-3-8-2-18 2-26l-2-12 10 8c6-3 14-3 20 0l9-9 1 13c4 8 3 18-2 25',
        'M49 49c-10 5-28 5-39 1',
        'M44 45c3-5 6-10 9-15',
        'M50 31c1-3 5-3 6 0 1 3-2 5-4 5-2 0-3-2-2-5z',
        'M55 29c0-6 0-11 1-15',
        'M56 5c2-3 5-1 4 2 3 0 4 3 1 4 2 2 0 5-2 4-1 3-5 3-5 0-3 1-4-2-2-4-3-1-2-4 1-4-1-3 2-4 3-2z',
        'M24 50l-1 6 4-3 3 4 1-6'],
    fill: ['M13 36a7 7 0 1 0 14 0a7 7 0 1 0-14 0', 'M29 35a7 7 0 1 0 14 0a7 7 0 1 0-14 0'] },
  { name: 'googly-hands', box: '0 0 64 64', w: 2,
    d: ['M32 8c10-1 18 7 18 17s-8 17-18 17-18-7-18-17 8-17 18-17z',
        'M30 10c10-1 17 6 17 15',
        'M14 44c-4 2-5 8-1 11 3 2 7 1 9-1 1 3 5 3 6 0 1-3-2-5-5-5-2-3-6-6-9-5z',
        'M36 46c-2 3-1 8 3 9 3 1 6-1 7-3 2 2 6 1 6-2 0-3-3-4-5-4-2-3-8-3-11 0z',
        'M56 38l1.5-4 1.5 4 4 1.5-4 1.5-1.5 4-1.5-4-4-1.5z',
        'M6 30c-2-2 0-5 2-3 2-2 4 1 2 3l-2 2z',
        'M10 19l4 1M11 22l3 1'],
    fill: ['M22 25a5 7 0 1 0 10 0a5 7 0 1 0-10 0', 'M34 27a5 7 0 1 0 10 0a5 7 0 1 0-10 0'] },
  { name: 'sleepy-blob', box: '0 0 64 64', w: 2,
    d: ['M8 50c0-16 10-26 24-26s24 10 24 26',
        'M5 53c10 3 44 3 54 0',
        'M21 38c2-1.5 5-1.5 7 0', 'M37 38c2-1.5 5-1.5 7 0',
        'M32 42h.5',
        'M17 51c0-5 3-8 7-8s7 3 7 8', 'M34 51c0-5 3-8 7-8s7 3 7 8',
        'M44 30l-5 5M48 34l-7 7',
        'M33 5h6l-6 7h6', 'M43 3h4l-4 5h4', 'M50 11h3l-3 4h3'] },
  { name: 'ring-eyes', box: '0 0 64 64', w: 2,
    d: ['M32 8c14 0 24 10 24 24s-10 24-24 24S8 46 8 32 18 8 32 8z',
        'M29 10c14-1 24 9 25 22',
        'M21 25a9 9 0 1 0 .1 0z', 'M43 23a9 9 0 1 0 .1 0z',
        'M20 50l6-4M27 52l6-4'],
    fill: ['M16.5 34a2.5 3.5 0 1 0 5 0a2.5 3.5 0 1 0-5 0', 'M42.5 33a2.5 3.5 0 1 0 5 0a2.5 3.5 0 1 0-5 0'] },
  { name: 'ghost', box: '0 0 64 64', w: 2,
    d: ['M16 54V28c0-10 7-18 16-18s16 8 16 18v26l-5-4-5 4-6-4-6 4-5-4z',
        'M19 38l3 1M42 39l3-1'],
    fill: ['M23 30a3 4 0 1 0 6 0a3 4 0 1 0-6 0', 'M35 30a3 4 0 1 0 6 0a3 4 0 1 0-6 0'] },
  { name: 'mushroom', box: '0 0 64 64', w: 2,
    d: ['M10 30c0-12 10-20 22-20s22 8 22 20c-6 3-38 3-44 0z',
        'M24 32c-1 8-1 15 0 20h16c1-5 1-12 0-20',
        'M20 17a3 3 0 1 0 .1 0z', 'M40 13a3 3 0 1 0 .1 0z',
        'M29 46c2 2 4 2 6 0'],
    fill: ['M26.5 40a1.5 2 0 1 0 3 0a1.5 2 0 1 0-3 0', 'M34.5 40a1.5 2 0 1 0 3 0a1.5 2 0 1 0-3 0'] },
  { name: 'star-buddy', box: '0 0 64 64', w: 2,
    d: ['M32 6l7 16 17 2-13 11 4 17-15-9-15 9 4-17L8 24l17-2z',
        'M28 36c2 2 6 2 8 0',
        'M54 50l1-3 1 3 3 1-3 1-1 3-1-3-3-1z'],
    fill: ['M25.2 29a1.8 2.4 0 1 0 3.6 0a1.8 2.4 0 1 0-3.6 0', 'M35.2 29a1.8 2.4 0 1 0 3.6 0a1.8 2.4 0 1 0-3.6 0'] },
  { name: 'peeking-cat', box: '0 0 64 64', w: 2,
    d: ['M6 46h52',
        'M14 46c0-10 6-18 18-18s18 8 18 18',
        'M17 33l-3-11 9 7', 'M47 33l3-11-9 7',
        'M19 46c0-3 6-3 6 0', 'M39 46c0-3 6-3 6 0'],
    fill: ['M22.5 37a3.5 4.5 0 1 0 7 0a3.5 4.5 0 1 0-7 0', 'M34.5 37a3.5 4.5 0 1 0 7 0a3.5 4.5 0 1 0-7 0'] },
];

const pool = [...sketches.map(s => ({ ...s, w: 1.6 })), ...cute];
 ...
 *
 * - STORAGE: ${pool.length} doodles. The first ${sketches.length} are the blog's marginalia
 ...
 */
(function () {
  var DOODLES = ${JSON.stringify(pool, null, 0).replace(/\},\{/g, '},\n    {')};

  var SCRIPT = document.currentScript;
  var ANCHOR = SCRIPT ? SCRIPT.getAttribute('data-anchor') : null;
  var CLASSIC_COUNT = ${sketches.length};
...
`;
writeFileSync('/tmp/dood/doodles.js', js);

// preview sheet
let cells = pool.map(s => `<div class="c"><svg viewBox="${s.box}" fill="none" stroke="currentColor" stroke-width="${s.w}" stroke-linecap="round" stroke-linejoin="round">${(s.d||[]).map(d=>`<path d="${d}"/>`).join('')}${(s.fill||[]).map(d=>`<path d="${d}" fill="currentColor" stroke="none"/>`).join('')}</svg><div>${s.name}</div></div>`).join('');
writeFileSync('/tmp/dood/preview.html', `<html><body style="margin:0;background:#e8dfc9;font:12px sans-serif;color:#2b2723"><style>.g{display:grid;grid-template-columns:repeat(5,200px);gap:8px;padding:10px}.c{text-align:center}.c svg{width:180px;height:180px;background:#efe7d3}</style><div class="g">${cells}</div></body></html>`);
